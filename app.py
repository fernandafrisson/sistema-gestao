...
def modulo_rh():
    ...
    with tab_rh2:
        ...
        # --- ESTRUTURA DA PÁGINA REORGANIZADA ---
        ...
        # --- CALENDÁRIO MOVIDO PARA O FINAL E COM TAMANHO REDUZIDO ---
        ...
        with col_cal_2:
            ...
            calendar_options = {
                ...
                "locale": "pt-br",
                "height": "600px" # Definindo uma altura fixa
            }
...
def main_app():
    # ... (código da navegação principal permanece o mesmo) ...
